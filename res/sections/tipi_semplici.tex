...
\begin{prooftree}
\AxiomC{$Id(A,x,y)$ type $[\Gamma, x \in A, y \in A]$}
\AxiomC{$a = a \in A \quad [\Gamma]$}
\AxiomC{$a = b \in A \quad [\Gamma]$}
...
\begin{prooftree}
\AxiomC{$id(a) \in Id(A,a,a) \quad [\Gamma]$}
\AxiomC{$Id(A,a,a) = Id(A,a,b)\quad [\Gamma]$}
